...
fwrite($handle, $trial);
$trial_file = "../upload/worksheet/".$userFolder.'/'.$sheetGroupFolder.'/'.$sheetFolder.'/'.$trial_file;
...
if($_POST['input']){
    ...
    $input_file = "../upload/worksheet/".$userFolder.'/'.$sheetGroupFolder.'/'.$sheetFolder.'/'.$input_file;
}
...
$output_file = "../upload/worksheet/".$userFolder.'/'.$sheetGroupFolder.'/'.$sheetFolder.'/'.$output_file;
...
if($_POST['main']){
    ...
    $main_file = "../upload/worksheet/".$userFolder.'/'.$sheetGroupFolder.'/'.$sheetFolder.'/'.$main_file;
}
...
if($_POST['objective']){
    ...
    $objective_file = "../upload/worksheet/".$userFolder.'/'.$sheetGroupFolder.'/'.$sheetFolder.'/'.$objective_file;
}
...
if($_POST['theory']){
    ...
    $theory_file = "../upload/worksheet/".$userFolder.'/'.$sheetGroupFolder.'/'.$sheetFolder.'/'.$theory_file;
}
