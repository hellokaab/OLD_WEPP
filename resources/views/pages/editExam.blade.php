...
@section('content')
    <script src="js/Components/editExamCtrl.js"></script>
    <script>
        var examId = {{$examId}};
        var keywords = findKeywordByEID(examId);
        var countOldKeyword = keywords.length;
    </script>
    <div ng-controller="editExamCtrl">
        <div class="col-lg-12">
                                ...
                                <div id="keyword_part">
                                    <div class="form-group has-feedback" ng-repeat="k in keywords" style="padding-left: 15px;padding-right: 15px">
                                        ...
                                        <div class="col-md-2" style="padding-right: 0">
                                            <button class="btn btn-warning btn-block" data-toggle="modal" ng-click="editKeyword(k.id,k.keyword_data)">
                                                <i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i>  แก้ไข
                                            </button>
                                        </div>
                                        <div class="col-md-2" style="padding-right: 0">
                                            <button class="btn btn-danger btn-block" data-toggle="modal" ng-click="deleteKeyword(k.id)">
