...
@section('content')
    <script src="js/Components/teacher/pointBoardCtrl.js"></script>
    <script>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="form-horizontal" role="form">
                                        <div class="form-group" style="margin-bottom: 0">
                                            ...
                                            <div class="col-md-4">
                                                <button type="button" class="btn btn-outline-warning" ng-hide="changeScore" ng-click="editScore()">แก้ไข</button>
