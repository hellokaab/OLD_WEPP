...
//        var mysections = findMySection(myuser).responseJSON;
    ...
    <div ng-controller="examCtrl" style="display: none" id="exam_div">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <b style="color: #555">กลุ่มข้อสอบ</b>
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                        <tr ng-show="allSection.length > 0" dir-paginate="g in allSection|orderBy:[sortC,sortS]|filter:query|itemsPerPage:selectRow">
                        ...
                        <tr ng-hide="allSection.length > 0">
                            <td>ไม่พบข้อมูล</td>
                            <td></td>
                            <td></td>
                        </tr>
        ...
        <div class="col-lg-6" id="divExamList" style="display: none">
            <div class="panel panel-default" ng-repeat="g in allSection" ng-hide="groupId != <%g.id%>">
                <div class="panel-heading">
